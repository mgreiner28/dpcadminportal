...
<!-- End Facebook Pixel Code -->
  ...
  <body class="body-style">
      ...
      <div  id="navigation-desktop" class="hidden-xs" >
            ...
            <nav class="navbar navbar-esr navbar-fixed-top">
      <div class="container-fluid">
          <div class="navbar-header" style="height: 55px;">
        
            <a class="navbar-brand" href="<?php echo esc_url(home_url('/')); ?>"><img src="/wp-content/uploads/2015/11/logo_desktop_horizontal.png"></a>
        </div>
      ...
      <div class="container-fluid" style="background-color: #000;height:200px; background-image: url('http://empirestateride.com/wp-content/uploads/2016/10/ESR-interior-header1_03.jpg');background-position:center; background-size:cover; background-repeat: no-repeat;margin-top: 40px;"></div>
