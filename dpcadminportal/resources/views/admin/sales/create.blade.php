...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('buyer_approval_letter', 'Buyer Approval Letter', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('tax_certificate', 'Tax Certificate', ['class' => 'control-label']) !!}
            ...
            <div class="row">
                <div class="col-xs-12 form-group">
                    {!! Form::label('seach_taxes_deed', 'Seach, Taxes, Deed Sent to Buyer Attorney', ['class' => 'control-label']) !!}
